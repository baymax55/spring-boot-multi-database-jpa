...
public class PrimaryJpaConfig {
    static final String REPOSITORY_PACKAGE = "com.baymax.springbootmultidatasourcejpa.repository.primary";
    private static final String ENTITY_PACKAGE = "com.baymax.springbootmultidatasourcejpa.entity.primary";
