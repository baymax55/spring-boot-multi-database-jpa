...
public class SecondJpaConfig {
    static final String REPOSITORY_PACKAGE = "com.baymax.springbootmultidatasourcejpa.repository.second";
    private static final String ENTITY_PACKAGE = "com.baymax.springbootmultidatasourcejpa.entity.second";
